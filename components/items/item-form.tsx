    ...
    <form onSubmit={handleSubmit} className="space-y-5 max-h-[75vh] overflow-y-auto pr-1">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          {form.images.length < 4 && (
            <button
              ...
              className="h-20 w-20 rounded-xl border-2 border-dashed border-slate-300 hover:border-indigo-400 hover:bg-indigo-50 transition-colors flex flex-col items-center justify-center text-slate-400 hover:text-indigo-500"
            >
              {imgLoading ? (
      ...
      <div className="flex gap-2 pt-2 border-t border-slate-100">
        ...
        <Button
          type="submit"
          disabled={loading}
          className="flex-1 bg-gradient-to-r from-teal-500 to-indigo-600 text-white border-0 hover:from-teal-600 hover:to-indigo-700"
        >
