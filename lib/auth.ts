// Sellora – Frontend Auth Helpers (localStorage-based)
...
const SESSION_KEY = "sellora_session";
const USERS_KEY = "sellora_users";

// Old keys for migration
const OLD_SESSION_KEY = "nexashopping_session";
const OLD_USERS_KEY = "nexashopping_users";

/**
 * Migrate data from old keys to new sellora keys.
